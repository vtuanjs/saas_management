...
CREATE TABLE "role_permissions" (
	...
	CONSTRAINT "role_permissions_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects" ("id")
);
CREATE UNIQUE INDEX "role_permissions_unique_idx" ON "role_permissions" ("user_id", "permission_id", "role_id", "project_id", "org_id");
